          ...
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto">
                <h1>DApp de Un colecioneble de NFT's</h1>
                <form onSubmit={(event) => {
                  event.preventDefault()
                  const color = this.color.value
                  this.mint(color)
                }}>
                  <input type='text' className='form-control mb-1' placeholder='Ej: #FFFFFF' ref={(input) => {this.color = input}} />
                  <input type='submit' className='btn btn-primary btn-block' value='NUEVO NFT'/>
                </form>
